 ...
 * @LastEditTime: 2019-11-19 16:59:07
 */
...
interface ClapIconExtraProps {
  isClicked?: boolean;
}
type IconProps = StyledComponentProps<"svg", any, ClapIconExtraProps, never>;

const Icon = styled.svg<ClapIconExtraProps>`
  width: 33px;
